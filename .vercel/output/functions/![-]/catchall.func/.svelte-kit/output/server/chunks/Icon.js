import { a7 as sanitize_props, a9 as spread_attributes } from "./index2.js";
...
function Icon($$renderer, $$props) {
  ...
  $$renderer.component(($$renderer2) => {
    ...
    if (
      ...
      if (data.svg) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<svg${spread_attributes({ ...data.attributes }, null, void 0, void 0, 3)}>${html(data.body)}</svg>`);
      } else {
        $$renderer2.push("<!--[!-->");
        $$renderer2.push(`<span${spread_attributes({ ...data.attributes }, null)}></span>`);
      }
      $$renderer2.push(`<!--]-->`);
    } else {
      $$renderer2.push("<!--[!-->");
